...
As Axe API, we want to use internal codes for the CRUD operations. Also, we want to provide some escape points such as [Hooks](/advanced/hooks/index.html), [Events](/advanced/hooks/index.html#events), [Middlewares](/basics/middlewares/index.html), etc. By doing that, you can focus your business logic in your escape points.
